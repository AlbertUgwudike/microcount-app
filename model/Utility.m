classdef Utility
    methods (Static)
        ...
        function export_table = region2export(regions)
            ...
            export_table.cell_density_per_mm2 = [results.MicrogliaDensity]';
            ...
            export_table.average_soma_size_um2 = [results.AverageSomaSizeUm]';
            export_table.average_branch_point_count = [results.AverageBranchCount]';
            export_table.average_branch_length_um_per_branch = [results.AverageBranchLengthUm]';
            export_table.average_scholl_index = [results.AverageSchollIndex]';
            export_table.average_branch_area_um2 = [results.AverageBranchAreaUm2]';
            export_table.average_branch_length_per_cell_um = [results.AverageTotalBranchLengthUm]';
            ...
            export_table.tissue_area_mm2 = [results.RegionAreaMm2]';

classdef Atlas
    ...
    methods
        ...
        function borders = calc_borders(atlas, tform_data, locs)
            ...
            l_keys = [locs(l_abr_idx).RegionKey];

            r_abr_idx = [locs.Laterality] == Laterality.RIGHT;
            r_keys = [locs(r_abr_idx).RegionKey];
        ...
        function r_mask = create_dn_size_mask(atlas, region)
            ...
            dn_mask = atlas.fill_region({ region.Location.RegionKey.Name }, ali_img);
        ...
        function img = get_reference_img(atlas, ori, idx)
            arguments
                atlas Atlas
                ori Orientation
                idx uint16
        ...
        function sz = get_size(atlas, ori)
            arguments
                atlas Atlas
                ori Orientation
            end

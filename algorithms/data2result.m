function [result, img, tables] = data2result(data, pixel_dims)
    ...
    cell_process_lengths = cellfun(@(r) sum(r), data.branch_lengths);
    total_length = sum(cell_process_lengths);
    ...
    tables = MicrocountTables( ...
        ...
        BranchAreas         = reshape(branch_areas_per_cell, [], 1), ...
        BranchLengthAv      = reshape(av_process_per_cell, [], 1) ...
    );

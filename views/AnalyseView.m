...
%                 MagicButton
    ...
    methods ( Access = protected ) 
        ...
        function setup(view) 
            ...
            view.SettingGrid.ColumnWidth = {'1x', '1x', '1x', '1x', '1x', '1x', '1x'};
            ...
            view.OverlapEditField = uieditfield(view.SettingGrid, 'numeric');
            view.OverlapEditField.HorizontalAlignment = 'center';
            view.OverlapEditField.Layout.Row = 1;
            view.OverlapEditField.Layout.Column = 5;
...
%             view.MagicButton.Text = 'Magic';
            ...
            view.RegionTable.ColumnName = {'RegionID'; 'Branch Threshold'; 'CoMarker Threshold'; 'Max CoMarker Size'; 'Overlap Percentage'; 'Soma Threshold'; 'Processed'};
            view.RegionTable.ColumnWidth = {'4x', '4x', '4x', '4x', '4x', '4x', '4x'};
            ...
            view.RegionTable.ColumnEditable = [false, true, true, true, true, true, false];
